...
private static void EmitAlphaIndices(ReadOnlySpan<TextureColor> pixels, byte min, byte max, Span<byte> indices)
{
...
return DXT.Encode(writer, image, endian, false, DXT2_RGBA.EncodeBlock, EncodeAlpha);
}
