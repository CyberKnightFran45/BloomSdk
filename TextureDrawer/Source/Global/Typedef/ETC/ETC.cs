...
public static int Encode(Stream writer, SKBitmap image, Endianness endian, ETCEncoder encodeFunc)
{
...
public static SKBitmap Decode(Stream reader, int width, int height, Endianness endian, ETCDecoder decodeFunc)
{
