...
return DXT5_RGBA_Padding.Write(target, source, blockSize, ENDIAN);
}
...
return DXT5_RGBA_Padding.Read(source, fileInfo.Width, fileInfo.Height, fileInfo.BlockSize, ENDIAN);
}
