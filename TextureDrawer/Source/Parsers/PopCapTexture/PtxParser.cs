...
{
PtxFormat.RGBA8888 => ABGR8888.Write(target, source, endian),
PtxFormat.RGBA4444 => RGBA4444.Write(target, source, endian),
PtxFormat.RGB565 => RGB565.Write(target, source, endian),
PtxFormat.RGBA5551 => RGBA5551.Write(target, source, endian),
PtxFormat.RGBA4444_Tiled => RGBA4444_Tiled.Write(target, source, endian),
PtxFormat.RGB565_Tiled => RGB565_Tiled.Write(target, source, endian),
PtxFormat.RGBA5551_Tiled => RGBA5551_Tiled.Write(target, source, endian),
PtxFormat.PVRTC_4BPP_RGBA => PVRTC_4BPP_RGBA.Write(target, ref source, endian),
PtxFormat.ETC1_RGB_A8 => ETC1_RGB_A8.Write(target, source, endian),
PtxFormat.ETC1_RGB_A_Palette => ETC1_RGB_A_Palette.Write(target, source, out alphaSize, endian),
PtxFormat.PVRTC_4BPP_RGB_A8 => PVRTC_4BPP_RGB_A8.Write(target, ref source, endian),
_ => ARGB8888.Write(target, source, endian)
};
...
public static void EncodeFile(string inputPath, string outputPath, string pathToInfo, PtxFormat format,
                              Endianness endian = default)
{
TraceLogger.Init();
...
TraceLogger.WriteDebug($"{inputPath} --> {outputPath} ({endian})");
...
{
PtxFormat.RGBA8888 => ABGR8888.Read(source, width, height, endian),
PtxFormat.RGBA4444 => RGBA4444.Read(source, width, height, endian),
PtxFormat.RGB565 => RGB565.Read(source, width, height, endian),
PtxFormat.RGBA5551 => RGBA5551.Read(source, width, height, endian),
PtxFormat.RGBA4444_Tiled => RGBA4444_Tiled.Read(source, width, height, endian),
PtxFormat.RGB565_Tiled => RGB565_Tiled.Read(source, width, height, endian),
PtxFormat.RGBA5551_Tiled => RGBA5551_Tiled.Read(source, width, height, endian),
PtxFormat.PVRTC_4BPP_RGBA => PVRTC_4BPP_RGBA.Read(source, width, height, endian),
PtxFormat.ETC1_RGB_A8 => ETC1_RGB_A8.Read(source, width, height, endian),
PtxFormat.ETC1_RGB_A_Palette => ETC1_RGB_A_Palette.Read(source, width, height, endian),
PtxFormat.PVRTC_4BPP_RGB_A8 => PVRTC_4BPP_RGB_A8.Read(source, width, height, endian),
_ => ARGB8888.Read(source, width, height, endian)
};
