...
{
/// <summary> Variation of the PacketCryptor, used starting from <c>v3.7.8</c> </summary>

internal static class PacketCryptorV2
{
...
{
var key = KeyFactoryV2.GetKey(vType);
var iv = KeyFactoryV2.GetIV(vType, key);
