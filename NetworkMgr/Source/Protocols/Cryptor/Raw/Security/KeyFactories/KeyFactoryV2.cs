...
{
/// <summary> Variation of the Key Factory, now uses different Prefix and Suffix </summary>

internal static class KeyFactoryV2
{
// Key Prefix 

private static readonly byte[] KEY_PREFIX = "VxS9Rm7f"u8.ToArray();

// Key Suffix

private static readonly byte[] KEY_SUFFIX = "8gKT_638"u8.ToArray();
