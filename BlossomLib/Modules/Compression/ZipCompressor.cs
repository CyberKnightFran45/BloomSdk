...
using FileStream input = FileManager.OpenRead(fullPath);
...
using FileStream output = FileManager.OpenWrite(outputFile);
...
using FileStream input = FileManager.OpenRead(inputPath);
TraceLogger.WriteActionEnd();
