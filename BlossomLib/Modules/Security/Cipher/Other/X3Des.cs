...
public static NativeMemoryOwner<char> Encrypt(byte[] data, byte[] key, byte[] iv = null,
...
return InputHelper.ConvertHexString(encryptedBytes, StringCase.Upper);
}
...
CipherMode mode = CipherMode.ECB, PaddingMode padding = PaddingMode.None)
{
using var xOwner = InputHelper.ConvertHexBytes(data);
