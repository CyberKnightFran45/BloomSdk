...
nonce.CopyTo(encrypted.AsSpan(0, NONCE_LENGTH) );

var dataIndex = (ulong)NONCE_LENGTH;
var cipherText = encrypted.AsSpan(dataIndex, inputLen);

var tagIndex = (ulong)(NONCE_LENGTH + inputLen);
var tag = encrypted.AsSpan(tagIndex, tagSizeInBytes);
