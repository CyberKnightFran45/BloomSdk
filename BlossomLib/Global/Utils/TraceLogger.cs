...
msg.CopyTo(_buffer.AsSpan(_position) );
...
var span = _buffer.AsSpan(0, (int)_position);
int newLines = 0;

for(int i = span.Length - 1; i >= 0 && newLines < maxLines; i--)
{
...
{
ulong newSize = _buffer.Size + additional;
