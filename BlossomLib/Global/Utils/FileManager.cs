...
public static void Process(Stream input, Stream output, BytesTransform transform,
...
BytesTransform2 transform, long maxBytes = -1, Action<long, long> progressCallback = null)
{
int blockSize = MemoryManager.GetBlockSize(input);
using NativeMemoryOwner<byte> inputOwner = new(blockSize);
